...
const ToolBarTop: FC = () => {
  ...
  const handleSaveAsClick = () => {
    ...
    fileSave(blob, {
      fileName: 'unnamed-blueprint.stbp', // TODO: name this
      description: 'Stellar blueprint file',
      mimeTypes: ['application/json'],
      extensions: ['.stbp'],
    });
      ...
      <ControlMenu.Container>
        <ControlMenu.Button label="File">
          <ContextMenu.Container>
            ...
            <ContextMenu.Button disabled onClick={handleSaveClick}>
              Save
            </ContextMenu.Button>
            <ContextMenu.Button onClick={handleSaveAsClick}>
              Save as...
            </ContextMenu.Button>
