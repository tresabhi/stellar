...
import importifyStage from './importifyStage';
...
export default function importifyBlueprint(providedBlueprint: AnyBlueprint) {
  ...
  // STEP 4: Importify all stages
  newBlueprint.stages.forEach((stage, index) => {
    newBlueprint.stages[index] = importifyStage(stage);
  });
